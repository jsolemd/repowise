...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("bounded_fan_out", "advisory", ("resource_concurrency_contract", "effect_and_failure_ordering"), "self._sem"),
        ("retry_loop", "advisory", ("batch_api_contract", "result_equivalence", "retry_and_failover_ordering"), None),
    ],
)
