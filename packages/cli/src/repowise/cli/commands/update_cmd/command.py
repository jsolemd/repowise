...
def run_update(
    ...
    #
    # Ahead of the fork's recipe-only fast path below, deliberately: that path
    # returns before any tombstone runs, so ordering it first would leave a
    # page for a deleted file serving until the next update.
    if stale_db_paths:
    ...
    if index_only:
        ...
        try:
            ...
            _persist_index_only_update(
                ...
                force_full_rescore=health_config_changed or prune_retry,
