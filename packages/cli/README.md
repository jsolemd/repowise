...
Exposes 29 registered MCP tools (12 advertised by default in single-repo mode:
the eleven flagship tools plus `list_repos`) for querying wiki pages, symbols, the
