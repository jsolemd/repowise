...
``list_repos`` discovery utility by default. Twenty-nine further tools (get_dependents,
get_dependency_path,
...
journal is configured. The selection layer lives in :mod:`._tool_selection`.
